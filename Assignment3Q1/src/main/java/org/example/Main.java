...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //testing and showing functionality of each required function
            getAllStudents();
    ...
    //getAllStudents: returns all of the students in the database
    ...
    //addStudent: add a student to the end of the database
    ...
    //updateStudentEmail: updates the students email based on the student ID
    ...
    //deleteStudent: deletes student based on the student ID
